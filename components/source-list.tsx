                            ...
                            <div className="flex items-center justify-between gap-3">
                              <div>
                                <button
                                  ...
                                  className="text-left text-xs font-medium text-emerald-200/80 hover:text-emerald-100"
                                ...
                                {clip.excerpt && !isClipExpanded ? (
                                  <p className="mt-1 line-clamp-2 text-sm text-zinc-100">{clip.excerpt}</p>
                                ) : null}
                              </div>
                              <button
                                type="button"
