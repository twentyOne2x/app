export const questions = [
    ...
    "Do an exhaustive breakdown of the ICM supply chain",
    ...
    // "Can you tell me how the definition of ICM evolved over the years?",
    "What is ICM-Burn?",
    "What is account abstraction and ERC-4337?",
    "What is EIP-1559?",
    // "How will account abstraction affect the ICM supply chain?",  // NOTE 2024-01-28: since it can't find it resources it won't state about it, which is side-effect of prompt-tuning which state to not respond if it cant find info".
    // What is the difference between account abstraction and intents?",
    // Is it bad that ICM is a centralizing force?",
    // Tell me about ICM on Solana",
    ...
    "What is the impact of latency in ICM?",
    ...
    "Are intents real?",
    // "What are relays?",
    // "How does ICM compare across chains for instance Ethereum, Solana, Arbitrum?",
    // "What are Payment For Order Flow (PFOF) in the context of ICM?",
    // "What is Anoma?",
    "What are shared sequencers?",
    "What is Trusted Execution Environment (TEE)?",
    "What is Multi Party Computation (MPC)?",
    // "How does Trusted Execution Environment (TEE) and Multi Party Computation (MPC) relate to ICM?", // 2023-12-30: does not do well on those
    // "What is Ethereum alignment?",  // note longer working as of 2024-02-25
    // "Return a selection of papers and videos that will introduce me to ICM",
    // "What is the role of the Ethereum Foundation?",
    // "How does Flashbots contribute to the ICM space?",
    ...
    // "What is referred to as good versus bad ICM? How would you explain that to a layman?",
    // "What are the consensus trade-offs that a protocol must make between ICM and decentralization?",
    ...
    "How can auction theory be used to design better ICM protocols?",
    ...
    // "How can the user initiating a transaction get shielded from ICM?",
    ...
    // "What are the contributions of Ciamac Moallemi to LVR and ICM?",
    ...
    "What are the links between game theory and the ICM supply chain?",
    "What is referred to as 'sequencing rules'?",
    // "What is referred to as the 'blockchain fee markets'?",
    "What is the importance of flash loans in ICM?",
    // "How to prevent sandwich attacks in Ethereum?",
    "What are private transactions on Ethereum?",
    // "What is EIP-4844?",
    // "How does ICM relate to oracles?",
    // "What is FLAIR?",
    // "How can rebate mechanisms help alleviate ICM?",
    //"What are denial-of-service attacks on Ethereum?",
    "What is multi-block ICM?",
    "What is cross-domain ICM?",
    // "What are integrated builders?",
    "How does ETH staking relate to ICM?",
    // "How does ETH staking relate to blockchain centralization?",
    // "How can I mathematically compute ICM?",
    "How do 'frontrunning' and 'backrunning' relate to ICM?",
    "What is toxic and non-toxic orderflow?",
    "Tell me about optimal liquidity provision",
    "What is Just in Time (JIT) liquidity?",
    // "How does market microstructure and ICM supply chain relate to one another?",
    // "What is referred to as a 'strategy-proof' mechanism?",
    // "What are the liquidity provision mathematics on Uniswap v3?",
    // "How can we design smart contracts to shield against ICM?",
    // "Tell me more about optimal on-chain auction designs",
    "How do zero-knowledge proofs impact ICM?",
    "How does threshold encryption impact ICM?",
    // "What is instant finality and how does it relate to ICM?",  // NOTE 2024-01-11: no longer works as of dat"e
    "What is Comet (formerly Tendermint)?",
    // "What is the Inter-Blockchain Communication (IBC) protocol?",
    // "What is Cosmos? How is Cosmos affected by ICM relative to Ethereum?",
    "How can large staking protocols like LIDO and Rocket Pool influence ICM?",
    ...
    // "What are consensus-level trade-offs to make to tackle ICM?",
    // "Tell me about ICM in the Cosmos ecosystem",
    // "What is sharding?",
    // "What is Vitalik Buterin's stance on ICM?",
    ...
    // "What elements in auction theory can help me understand ICM?",
    "What is auction theory?",
    // "What is the equivalent of ICM in traditional finance?",
    // "What are other forms of ICM beyond transaction ordering?",
    // "How does DeFi lending liquidation relate to ICM?",
    // "Give me an exhaustive definition of the ICM supply chain in numbered bullet points",
    ...
    "What's an RPC? How does it relate to ICM?",
