...
export async function middleware(req: NextRequest) {
  ...
  // Handle anonymous users - always set cookie if not present
  ...
  if (!anonymousIdCookie) {
    ...
    console.log(`Set anonymousId cookie: ${anonymousId}`);
  } else {
    console.log(`Existing anonymousId cookie: ${anonymousIdCookie.value}`);
  }
